...
func _ready():
	...
	$Camera2D2/ColorRect/ColorRect/Ability1.text = nameAbility1;
	$Camera2D2/ColorRect/ColorRect/Ability2.text = nameAbility2;
	var res1 = load("res://Assets/icons/"+Ability1Src)
	var res2 = load("res://Assets/icons/"+Ability2Src)
	$Camera2D2/ColorRect/ColorRect/ability1.texture = res1;
	$Camera2D2/ColorRect/ColorRect/ability2.texture = res2;
...
func draw_info():
	...
	if not switcher:
		$Camera2D2/ColorRect/ColorRect/ability1.modulate = Color(1,1,1,1)
	else: $Camera2D2/ColorRect/ColorRect/ability1.modulate = Color(1,1,1,0.45)
